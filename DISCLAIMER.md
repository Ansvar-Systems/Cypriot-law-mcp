...
- **No Attorney-Client Relationship**: Use of this Tool does not create an attorney-client relationship (σχέση εντολέα-δικηγόρου / advocate-client relationship)
...
If you are a lawyer (δικηγόρος / advocate), legal researcher, or other legal professional:

- **Malpractice Risk**: Relying on unverified information from this Tool in professional legal work may constitute professional malpractice (επαγγελματική αμέλεια / professional negligence)
...
- **Professional Rules**: Members of the Cyprus Bar Association (Παγκύπριος Δικηγορικός Σύλλογος — ΠΔΣ) must comply with applicable professional conduct rules (Κώδικας Δεοντολογίας) when using AI tools
...
1. Checking the official source (cylaw.org — Official Legal Portal of the Republic of Cyprus)
2. Verifying the provision is currently in force and has not been amended or repealed
3. Reading the full context of cited provisions in both Greek and English where bilingual versions exist
4. Consulting case law (νομολογία) and explanatory materials for interpretation
...
This Tool aggregates data from official Cypriot legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **cylaw.org** | Authoritative | Statute text, consolidated legislation (primary reference) |
| **Official Gazette (Επίσημη Εφημερίδα)** | Authoritative | Primary legislation as enacted |
...
Cyprus operates a bilingual legal system. Many laws exist in both **Greek (Ελληνικά)** and **English**. When a discrepancy exists between language versions:

- The **official Gazette version** is authoritative
- This Tool may not capture all bilingual nuances
- Always verify the controlling language version for your specific matter

### Commercial Legal Databases

For professional legal work, **always cross-check with commercial legal databases** and the official Cypriot legal resources:

- cylaw.org (official), Νομολογία ΑΔΠ (Supreme Court decisions)

These resources provide editorial oversight and professional-grade currency guarantees that this Tool **cannot** provide.
...
- Cypriot law changes continuously through new statutes (νόμοι), amendments (τροποποιήσεις), and court decisions (αποφάσεις)
...
- Even "fresh" data may be outdated if recent amendments were published in the Επίσημη Εφημερίδα (Official Gazette)
- Staleness warnings do not guarantee completeness or accuracy
- Always check official sources for the current legal position (τρέχουσα νομική κατάσταση)

### Amendments and Repeals

- A provision marked "in force" may have been:
  - Amended (τροποποιηθεί) after the last database update
  - Repealed (καταργηθεί) but not yet removed from the database
  - Subject to transitional provisions (μεταβατικές διατάξεις) affecting its applicability
...
1. **Complete case law** — Coverage of the Supreme Court of Cyprus (Ανώτατο Δικαστήριο) and lower court decisions is limited; do not rely solely on this for case law research
2. **Historical statute versions** — Limited availability of historical provision wording
3. **Legal commentary** — No editorial annotations, academic commentary (νομική θεωρία), or practice guides
4. **Unpublished decisions** — District court decisions and administrative rulings largely absent
5. **Full legislative history** — Limited coverage of parliamentary materials (κοινοβουλευτικά πρακτικά)
...
- This includes but is not limited to:
  ...
  - Regulatory sanctions from bar authorities (πειθαρχικές κυρώσεις)
  - Reputational damage
...
- **Sensitive Matters**: For privileged legal matters (επαγγελματικό απόρρητο), consider on-premise deployment
...
2. **Official Verification**: Cross-check ALL results with official sources (cylaw.org)
3. **Bilingual Check**: Verify the controlling language version of each statute
...
6. **Update Check**: Before finalizing legal work, check for recent amendments in the Επίσημη Εφημερίδα

## Changes to This Disclaimer

This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Cypriot-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Cypriot-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (cylaw.org)
...
- **COMPLY** with Παγκύπριος Δικηγορικός Σύλλογος (ΠΔΣ) professional ethics rules regarding AI tool use and client confidentiality
- **DISCLOSE** to clients if required by professional rules (Κώδικας Δεοντολογίας)
