/**
 * Tool registry for Cypriot Law MCP Server.
...
import { getCypriotImplementations, type GetCypriotImplementationsInput } from './get-cypriot-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including the CyLaw (Cyprus Bar Association Legal Portal). ' +
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Cypriot statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Cypriot statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_cypriot_implementations',
    description:
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that are referenced by Cypriot legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_cypriot_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents referenced by Cypriot legislation.',
        },
  ...
  },
  {
    ...
    description:
      ...
      'NOTE: As of 2026-04-26 this index is being populated; CyLaw aggregator is not used (ToS) — ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_cypriot_implementations':
          result = await getCypriotImplementations(db, args as unknown as GetCypriotImplementationsInput);
          break;
