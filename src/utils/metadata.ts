...
export function generateResponseMetadata(
  ...
  return {
    data_source: 'Official Legal Database ([REDACTED]) — Government (State Chancellery of Cypriot)',
    jurisdiction: 'EE',
    disclaimer:
      ...
      'Always verify with the official Official Legal Database portal ([REDACTED]).',
    freshness,
  };
}
